...
export const ProfilePanel = () => {
    ...
    return (
        <div data-chat-notification>
            <Link data-notification href={{ pathname: isCommercial ? "/my-shop" : "/my-products" }}>
                <div data-svg>
            ...
            <Link data-notification href={{ pathname: `/messages` }}>
                <div data-svg>
            ...
            <Link data-notification href={{ pathname: `/notifications` }}>
                <div data-svg>
            ...
            <Link data-notification href={{ pathname: `/personal-data` }}>
                <div data-svg>
                    {photo ? (
